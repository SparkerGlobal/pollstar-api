/**
 * https://blog.pollstar.com/api/get-artist-routebook/
 * 
 * radius - integer
 * fromDate - mm/dd/yyy
 * toDate
...
async function artistRoutebook(artistId, query) {
    try {
        let url = `/artists/${artistId}/routebook`;
...
module.exports = artistRoutebook;